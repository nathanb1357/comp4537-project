...
class App {
  ...
  async logoutUser(event) {
    ...
    try {
      ...
      if (response.ok) {
        alert(userMessages.success.logoutSuccess);
        window.location.href = "index.html";
      } else {
        alert(userMessages.error.logoutFailed);
      }
    } catch {
      alert(userMessages.error.logoutFailed);
    }
  ...
  async deleteAccount(event) {
    ...
    try {
      ...
      if (data.error) {
        ...
        alert(userMessages.success.deleteAccountSuccess);
        window.location.href = "index.html";
      }
    } catch {
      alert(userMessages.error.deleteAccountFailed);
    }
  }
  ...
  async predictImage(event) {
    ...
    try {
      ...
      if (!response.ok) {
        alert(userMessages.error.predictImageFailed);
        return;
      }

      const prediction = await response.json();
      document.getElementById("result").textContent = `Predicted Class: ${prediction.predicted_class}, Confidence: ${prediction.confidence}, Class Confidence: ${prediction.class_confidence}`;
    } finally {
  ...
  async fetchUserInfo() {
    try {
      ...
      alert(userMessages.error.fetchUserFailed);
    }
  }
  ...
  async fetchAdminData() {
    try {
      ...
      alert(userMessages.error.adminDataFetchFailed);
    }
  }
